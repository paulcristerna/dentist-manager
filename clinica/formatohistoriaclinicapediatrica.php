<?php include("../header2.php"); ?>
    ...
    <?php include("../core-saec/Formato_Historia_Clinica_Pediatrica.php"); ?>
        ...
        <?php if($SIS_Datos_Usuario['NombrePuesto'] == "Alumno Operador/Asistente"): ?>
          <a href="../clinica/formatohistoriaclinicapediatrica-nuevo.php" class="btn btn-institucional pull-left">
            <i class="icon-plus-sign icon-white"></i> Llenar Nuevo Formato Historia Clínica Pediátrica
          </a>
        <?php endif; ?>
            
          <div class="input-append pull-right">
            <form method="get" action="formatohistoriaclinicapediatrica.php">
          ...
          <div class="row">
            <div class="span9">
                <a href="reportes/formatoshistoriaclinicapediatrica-generar-pdf.php?buscar=<?php echo (isset($_GET['buscar']) ? $_GET['buscar']:"") ?>" class="btn btn-institucional pull-right" target="_blank">Generar Reporte</a>
            </div>
          </div>
    ...
    $Formato_Historia_Clinica_Pediatrica = new Formato_Historia_Clinica_Pediatrica();
                ...
                if($SIS_Datos_Usuario['NombrePuesto'] == 'Administrador'){
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Administrador($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Administrador();
                    endif;
                }
                    ...
                    $Formato_Historia_Clinica_Pediatrica->IdParejaClinica = $DatosParejaClinica['IdParejaClinica'];
                    
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Medico_Titular($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Medico_Titular();
                    endif;
                }
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Alumno_Op_As($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Alumno_Op_As();
                    endif;
		    }
              ?>    
            </tbody> 
