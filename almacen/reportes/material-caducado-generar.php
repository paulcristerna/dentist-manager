    ...
    <table id="contenido">
      <thead>
          <tr style="background:#e3e3e3;">
            <th style="padding:5px;width:80px;">Codigo</th>
            <th style="padding:5px;width:300px;">Material</th>
            <th style="padding:5px;width:80px;">Cantidad</th>
            <th style="padding:5px;width:100px;">Unidad de Medida</th>
            <th style="padding:5px;width:80px;">Fecha de Caducidad</th>
          </tr>
        </thead>
        <tbody>
        <?php 
            $Material = new Material();
            $Material->Catalogo_Material_Caducado_Reporte($_GET['caducado']); 
        ?>
        </tbody>
    </table>
