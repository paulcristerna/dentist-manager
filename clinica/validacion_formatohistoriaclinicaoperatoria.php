...
include("../core-saec/Formato_Historia_Clinica_Operatoria.php");
...
if(isset($_REQUEST['guardar']))
{
    ...
    $Paciente = $_POST["sltpaciente-operatoria"];
    ...
    $Formato_Historia_Clinica_Operatoria->Alta();
} 
...
if(isset($_REQUEST['aprobar']))
{
    ...
    $Formato_Historia_Clinica_Operatoria->IdHistoriaClinicaOperatoria = $Historia_Clinica;
    $Formato_Historia_Clinica_Operatoria->Aprobado = $Aprobado;
    
    $Formato_Historia_Clinica_Operatoria->Aprobar();
}
?>