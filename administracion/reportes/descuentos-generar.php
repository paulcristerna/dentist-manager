    ...
    <table id="contenido">
      <thead>
          <tr style="background:#e3e3e3;">
            <th style="padding:5px;width:600px;">Nombre del Descuento</th>
            <th style="padding:5px;width:100px;">Porcentaje</th>
          </tr>
        </thead>
        <tbody>
        <?php     
            $Descuento = new Descuento();
            $Descuento->Catalogo_Descuentos_Reporte($_GET['buscar']); 
        ?>
        </tbody>
    </table>
