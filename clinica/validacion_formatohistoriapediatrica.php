...
include("../core-saec/Formato_Historia_Clinica_Pediatrica.php");
...
if(isset($_REQUEST['guardar']))
{
    ...
    $Paciente = $_POST["sltpaciente-pediatrica"];
    $Calle = $_POST["calle"];
    $Numero = $_POST["numero"];
    ...
    $GradoEscolar = $_POST["grado-escolar"];
    $NumHermanos = $_POST["num-hermanos"];
    $NombrePadre = $_POST["nombre-padre"];
    $OcupacionPadre = $_POST["ocupacion-padre"];
    $TelefonoPadre = $_POST["telefono-padre"];
    ...
    $EstadoActualSalud = $_POST["estado_actual_salud"];
    $EnfermedadesProlongadas = $_POST["enfermedades_prolongadas"];
    $UltimoExamenFisico = $_POST["ultimo_examen_fisico"];
    $RecibeAtencionMedica = $_POST["recibe_atencion_medica"];
    $RecibeAtencionMedicaPorque = $_POST["recibe_atencion_medica_porque"];
    $Operaciones = $_POST["operaciones"];
    $RecibidoTratamientoDental = $_POST["recibido_tratamiento_dental"];
    $Anestesiado = $_POST["anestesiado"];
    $EfectosAnestesia = $_POST["efectos_anestesia"];
    $OclusionMolaresDer = $_POST["oclusion_molares_derecha"];
    $OclusionMolaresIzq = $_POST["oclusion_molares_izquierda"];
    $SobremordidaVert = $_POST["sobremordida_vertical"];
    $SobremordidaHor = $_POST["sobremordida_horizontal"];
    $MordidaAbierta = $_POST["mordida_abierta"];
    $ErupcionTardia = $_POST["erupcion_tardia"];
    $DientesAusentes = $_POST["dientes_ausentes"];
    $PerdidaPrematura = $_POST["perdida_prematura"];
    $PerdidaProlongada = $_POST["perdida_prolongada"];
    $MordidaCruzadaPost = $_POST["mordida_cruzada_posterior"];
    $MordidaCruzadaAnt = $_POST["mordida_cruzada_anterior"];
    $EstadoPeriodontal = $_POST["estado_periodontal"];
    $Fistula = $_POST["fistula"];
    $Gingivitis = $_POST["gingivitis"];
    $Habitos = $_POST["habitos"];
    $DolorCabeza = $_POST["dolor_cabeza"];
    ...
    $AtendidoConsultarioDental = $_POST["atendido_consultorio_dental"];
    $ExperienciaDentalPrevia = $_POST["experiencia_dental_previa"];
    $PracticaDeporte = $_POST["practica_deporte"];
    $PracticaDeporteCual = $_POST["practica_deporte_cual"];
    $SuccionDedo = $_POST["succion_dedo"];
    $MorderseUnas = $_POST["morderse_unas"];
    $MorderseLabios = $_POST["morderse_labios"];
    $DuermeBocaAbierta = $_POST["duerme_boca_abierta"];
    $RechinarDientes = $_POST["rechinar_dientes"];
    $DolorCabezaFrecuente = $_POST["dolor_cabeza_frecuente"];
    $PadeceEnfermedadActualmente = $_POST["padece_enfermedad_actualmente"];
    $PadeceEnfermedadActualmenteCual = $_POST["padece_enfermedad_actualmente_cual"];
    $RecibiendoMedicamento = $_POST["recibiendo_medicamento"];
    $RecibiendoMedicamentoCual = $_POST["recibiendo_medicamento_cual"];
    $DesordenesEmocionales = $_POST["desordenes_emocionales"];
    $SangradoPersistente = $_POST["sangrado_persistente"];
    $Hepatitis = $_POST["hepatitis"];
    $Hemofilia = $_POST["hemofilia"];
    $FiebreReumatica = $_POST["fiebre_reumatica"];
    $Convulsiones = $_POST["convulsiones"];
    $ObstruccionNasalCronica = $_POST["obstruccion_nasal_cronica"];
    $AccidentesCabezaCara = $_POST["accidentes_cabeza_cara"];
    $AccidentesCabezaCaraCuando = $_POST["accidentes_cabeza_cara_cuando"];
    $Alergico = $_POST["alergico"];
    $AlergicoQue = $_POST["alergico_que"];
    $InfeccionesFrecuentesGarganta = $_POST["infecciones_frecuentes_garganta"];
    $OperadoAmigdalas = $_POST["operado_amigdalas"];
    $OperadoAmigdalasCuando = $_POST["operado_amigdalas_cuando"];
    $Adenoides = $_POST["adenoides"];
    $AdenoidesCuando = $_POST["adenoides_cuando"];
    $AusentesCongenitamente = $_POST["ausentes_congenitamente"];
    $Supernumerarios = $_POST["supernumerarios"];
    $Malformados = $_POST["malformados"];
    $LesionesPeriapicales = $_POST["lesiones_periapicales"];
    $Quistes = $_POST["quistes"];
    $Incluidos = $_POST["incluidos"];
    $RaicesAnormales = $_POST["raices_anormales"];
    $ResorcionRadicular = $_POST["resorcion_radicular"];
    $TercerosMolares = $_POST["terceros_molares"];
    $Traumatismos = $_POST["traumatismos"];
    $OtrasPatologias = $_POST["otras_patologias"];
    $Riesgo = $_POST["riesgo"];
    ...
    $Pregunta11 = $_POST["pregunta-11"];
    $DiagnosticoIntegral1 = $_POST["diagnistico-integral-1"];
    $DiagnosticoIntegral2 = $_POST["diagnistico-integral-2"];
    $DiagnosticoIntegral3 = $_POST["diagnistico-integral-3"];
    $DiagnosticoIntegral4 = $_POST["diagnistico-integral-4"];
    $DiagnosticoIntegral5 = $_POST["diagnistico-integral-5"];
    $DiagnosticoIntegral6 = $_POST["diagnistico-integral-6"];
    $Prevencion = $_POST["prevencion"];
    $Operacion = $_POST["operacion"];
    $OrtodonciaPreventiva = $_POST["ortodoncia-preventiva"];
    $Cita1 = $_POST["cita-1"];
    $Cita2 = $_POST["cita-2"];
    $Cita3 = $_POST["cita-3"];
    $Cita4 = $_POST["cita-4"];
    ...
    $Cita8 = $_POST["cita-8"];
    $Cita9 = $_POST["cita-9"];
    $Cita10 = $_POST["cita-10"];
    $Cita11 = $_POST["cita-11"]; 
	...
	$Conducta,
	$EstadoActualSalud,
	$EnfermedadesProlongadas,
	$UltimoExamenFisico,
	$RecibeAtencionMedica,
	$RecibeAtencionMedicaPorque,
	$Operaciones,
	$RecibidoTratamientoDental,
	$Anestesiado,
	$EfectosAnestesia,
	$OclusionMolaresDer,
	$OclusionMolaresIzq,
	...
	$Diente_75,
	$MotivoConsulta,
	$AtendidoConsultarioDental,
	$ExperienciaDentalPrevia,
	$PracticaDeporte,
	$PracticaDeporteCual,
	$SuccionDedo,
	$MorderseUnas,
	...
	$DuermeBocaAbierta,
	$RechinarDientes,
	$DolorCabezaFrecuente,
	$PadeceEnfermedadActualmente,
	$PadeceEnfermedadActualmenteCual,
	$RecibiendoMedicamento,
	$RecibiendoMedicamentoCual,
	$DesordenesEmocionales,
	$SangradoPersistente,
	$Hepatitis,
	$Hemofilia,
	$FiebreReumatica,
	$Convulsiones,
	$ObstruccionNasalCronica,
	$AccidentesCabezaCara,
	$AccidentesCabezaCaraCuando,
	$Alergico,
	$AlergicoQue,
	$InfeccionesFrecuentesGarganta,
	$OperadoAmigdalas,
	$OperadoAmigdalasCuando,
	$Adenoides,
	$AdenoidesCuando,
	$AusentesCongenitamente,
	$Supernumerarios,
	$Malformados,
	...
	$Pregunta10,
	$Pregunta11,
	$DiagnosticoIntegral1,
	$DiagnosticoIntegral2,
	$DiagnosticoIntegral3,
	$DiagnosticoIntegral4,
	$DiagnosticoIntegral5,
	$DiagnosticoIntegral6,
	$Prevencion,
	$Operacion,
    ...
    $Formato_Historia_Clinica_Pediatrica->Alta();   
}
