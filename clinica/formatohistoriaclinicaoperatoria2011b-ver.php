...
<?php include("../core-saec/Formato_Historia_Clinica_Operatoria_2011B.php"); ?>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <h2>Formato de Historia Clínica de Operatoria 2011-B</h2>

        <div class="well" style="width:1150px;">
            
        <form method="post" action="validacion_formatohistoriaclinicaoperatoria2011b.php">
        ...
        <input type="hidden" name="historia_clinica" id="historia_clinica" value="<?php echo $_GET['formato']; ?>">
          ...
          <ul class="nav nav-tabs" id="myTab">
            ...
            <li><a href="#tab2">Odontograma</a></li>
            <li><a href="#tab3">Cuadro de Avances</a></li>
          </ul>
            
          <?php 
            $Formato_Historia_Clinica_Operatoria_2011B = new Formato_Historia_Clinica_Operatoria_2011B();

            $Formato_Historia_Clinica_Operatoria_2011B->IdHistoriaClinicaOperatoria2011B = $_GET['formato'];

            $Datos_Formato = $Formato_Historia_Clinica_Operatoria_2011B->Obtener_Formato();
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab1">
              ...
              <br>
              <div class="row"> 
                <div class="span4"> <label><strong> Domicilio: </strong><?php echo $Datos_Formato['CallePaciente'].' '.$Datos_Formato['NumeroPaciente'].' '.$Datos_Formato['ColoniaPaciente'].' '.$Datos_Formato['PoblacionPaciente']; ?>.</label> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Dx y Tx Médico: </strong></label> </div>
                <div class="span3.5"> <input type="text" placeholder="Dx y Tx Médico" style="width:325%;" id="dx_tx_medico" name="dx_tx_medico" value="<?php echo $Datos_Formato['Dx_Tx_Medico']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2.5"> <label><strong> Observaciones Radiológicas </strong></label> </div>
                <div class="span5"> <textarea  rows="3" cols="10" style="width:105%;" placeholder="Observaciones Radiológicas" id="observaciones_radiologicas" name="observaciones_radiologicas"><?php echo $Datos_Formato['Observaciones_Radiologicas']; ?></textarea> </div>
              </div>
            </div><!-- fin tab1 -->
	      ...
	      <table>
	      <tr>
		<td>Diente Perdido (<strong>P</strong>)</td>
                <td>Caries (<strong>C</strong>)</td>
                <td>Dolor (<strong>D</strong>)</td>
                <td>Extracción Indicada (<strong>PI</strong>)</td>
                <td>Prótesis (<strong>PR</strong>)</td>
                <td>Obturación (<strong>O</strong>)</td>
                <td>Traumatismo (<strong>T</strong>)</td>
                <td>Maloclusiones (<strong>#</strong>)</td>
                <td>Obturación Defectuosa (<strong>OD</strong>)</td>
                <td>Endodoncia o Indicada (<strong>E</strong>)</td>
	      </tr>
	      </table>
	      ...
	      <table class="table table-striped tabla-centrada">                
              ...
              <br>
              <div class="row"> 
                <div class="span2"> <label><strong> Estado Periodontal </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Estado Periodontal" style="width:100%;" id="estado_periodontal" name="estado_periodontal" value="<?php echo $Datos_Formato['Estado_Periodontal']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
              ...
              <!--<br>
              <div class="row">
                <div class="span2.5"> <label><strong> Autorización del Operador: </strong></label> </div>
            ...
            <div class="row">
              ...
              <table class="table table-striped">
                <thead>
                  <th><center>Retauración Tipo y Pieza</center></th>
                  <th><center>Recibo Número</center></th>
                  <!--<th><center>Autorización Inicial</center></th>
                  <th><center>Autorización de la Cavidad</center></th>
                  <th><center>Autorización de  la Base</center></th>
                  <th><center>Restauración Finalizada</center></th>
                  <th><center>Operador</center></th>-->
                </thead>
                <tbody>
                  <tr> 
                    <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_1" name="restauracion_tipo_pieza_1" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_1']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_1" name="recibo_numero_1" value="<?php echo $Datos_Formato['Recibo_Numero_1']; ?>"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_2" name="restauracion_tipo_pieza_2" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_2']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_2" name="recibo_numero_2" value="<?php echo $Datos_Formato['Recibo_Numero_2']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_3" name="restauracion_tipo_pieza_3" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_3']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_3" name="recibo_numero_3" value="<?php echo $Datos_Formato['Recibo_Numero_3']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_4" name="restauracion_tipo_pieza_4" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_4']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_4" name="recibo_numero_4" value="<?php echo $Datos_Formato['Recibo_Numero_4']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_5" name="restauracion_tipo_pieza_5" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_5']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_5" name="recibo_numero_5" value="<?php echo $Datos_Formato['Recibo_Numero_5']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_6" name="restauracion_tipo_pieza_6" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_6']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_6" name="recibo_numero_6" value="<?php echo $Datos_Formato['Recibo_Numero_6']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_7" name="restauracion_tipo_pieza_7" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_7']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_7" name="recibo_numero_7" value="<?php echo $Datos_Formato['Recibo_Numero_7']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_8" name="restauracion_tipo_pieza_8" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_8']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_8" name="recibo_numero_8" value="<?php echo $Datos_Formato['Recibo_Numero_8']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_9" name="restauracion_tipo_pieza_9" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_9']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_9" name="recibo_numero_9" value="<?php echo $Datos_Formato['Recibo_Numero_9']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_10" name="restauracion_tipo_pieza_10" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_10']; ?>"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_10" name="recibo_numero_10" value="<?php echo $Datos_Formato['Recibo_Numero_10']; ?>"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
              ...
              <div class="row"> 
                <div class="span8"> <textarea rows="3" cols="10" style="width:105%;" placeholder="Observaciones" id="observaciones" name="observaciones"><?php echo $Datos_Formato['Observaciones']; ?></textarea> </div> 
              </div>
            </div><!-- fin tab3 -->
        </div><!-- fin tabcontent -->
        ...
        <div align="row">
          ...
          <a href="../clinica/formatohistoriaclinicaoperatoria2011b.php" class="btn btn-danger pull-right cancelar"> Cancelar</a>
        </div>
		<?php endif; ?>
      ...
      <input type="hidden" id="ventana" value="formato-historia-clinica-operatoria-2011b">
