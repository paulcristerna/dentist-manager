<?php include("../header2.php"); ?>
    ...
    <?php include("../core-saec/Formato_Historia_Clinica_Comunitaria.php"); ?>
        ...
        <?php if($SIS_Datos_Usuario['NombrePuesto'] == "Alumno Operador/Asistente"): ?>
          <a href="../clinica/formatohistoriaclinicacomunitaria-nuevo.php" class="btn btn-institucional pull-left">
            <i class="icon-plus-sign icon-white"></i> Llenar Nuevo Formato Historia Clínica Comunitaria
          </a>
        <?php endif; ?>
            
          <div class="input-append pull-right">
            <form method="get" action="formatohistoriaclinicacomunitaria.php">
          ...
          <div class="row">
            <div class="span9">
                <a href="reportes/formatoshistoriaclinicacomunitaria-generar-pdf.php?buscar=<?php echo (isset($_GET['buscar']) ? $_GET['buscar']:"") ?>" class="btn btn-institucional pull-right" target="_blank">Generar Reporte</a>
            </div>
          </div>
    ...
    $Formato_Historia_Clinica_Comunitaria = new Formato_Historia_Clinica_Comunitaria();
                ...
                if($SIS_Datos_Usuario['NombrePuesto'] == 'Administrador'){
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Comunitaria->Catalogo_Administrador($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Comunitaria->Catalogo_Administrador();
                    endif;
                }
                    ...
                    $Formato_Historia_Clinica_Comunitaria->IdParejaClinica = $DatosParejaClinica['IdParejaClinica'];
                    
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Comunitaria->Catalogo_Medico_Titular($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Comunitaria->Catalogo_Medico_Titular();
                    endif;
                }
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Comunitaria->Catalogo_Alumno_Op_As($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Comunitaria->Catalogo_Alumno_Op_As();
                    endif;
		    }
              ?>    
            </tbody> 
