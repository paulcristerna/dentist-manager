...
<head>
  <meta charset="utf-8">
  <title>Formato de Historia Pediatrica</title>
  <style type="text/css">
    table td, table th{
      text-align: center;
    }
    ...
    <table id="cabecera">
      <tr>
        ...
        <td style="width:470px;">
          <h4>Formato de Historia Pediatrica</h4>
         ...
         <?php 
                ...
                if($SIS_Datos_Usuario['NombrePuesto'] == 'Administrador'){
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Administrador_Reporte($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Administrador_Reporte();
                    endif;
                }
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Medico_Titular_Reporte($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Medico_Titular_Reporte();
                    endif;
                }
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Alumno_Op_As_Reporte($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Pediatrica->Catalogo_Alumno_Op_As_Reporte();
                    endif;
                }
              ?>  
        </tbody>
