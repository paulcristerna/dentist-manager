    ...
    <table id="contenido">
      <thead>
          <tr style="background:#e3e3e3;">
            <th style="padding:5px;width:200px;">Núm. de Cuenta/Empleado</th>
            <th style="padding:5px;width:240px;">Nombre Completo</th>
            <th style="padding:5px;width:240px;">Puesto</th>
          </tr>
        </thead>
        <tbody>
        <?php 
            $Usuario = new Usuario();
            $Usuario->Catalogo_Usuarios_Reporte($_GET['buscar']); 
        ?>
        </tbody>
    </table>
