<?php include("../header2.php"); ?>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <h2>Formato de Historia Clínica de Prótesis Parcial Removible</h2>

        <div class="well" style="width:1150px;">
            
        <form method="post" action="validacion_formatohistoriaclinicaprotesisparcialremovible.php">
        <input type="hidden" id="historia_clinica" name="historia_clinica" value="<?php echo $_GET['formato']; ?>">
          ...
          <ul class="nav nav-tabs" id="myTab">
            ...
            <li><a href="#tab2">Estado de Salud</a></li>
            <li><a href="#tab3">Características de los Dientes</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab1">
              ...
              <div class="row"> 
                <div class="span2">
                    <label><strong>Ocupación:</strong> <?php echo $Datos_Formato['OcupacionPaciente']; ?></label>
                </div> 
                <div class="span2">
            ...
            <div class="tab-pane" id="tab2">
              ...
              <br />
              <div class="row"> 
                <div class="span1.5"> <label><strong> Estado de Salud General: </strong></label> </div>
                <div class="span3.5"> <input type="text" placeholder="Estado de Salud General" style="width:450px;" id="estado_salud_general" name="estado_salud_general" value="<?php echo $Datos_Formato['Estado_Salud_General']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Problema Principal: </strong></label> </div>
                <div class="span3.5"> <input type="text" placeholder="Problema Principal" style="width:450px;" id="problema_principal_1" name="problema_principal_1" value="<?php echo $Datos_Formato['Problema_Principal_1']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Tratamiento: </strong></label> </div>
                <div class="span7"> <textarea rows="3" cols="10" style="width:100%;" placeholder="Tratamiento" id="tratamiento_1" name="tratamiento_1"><?php echo $Datos_Formato['Trtatamiento_1']; ?></textarea></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Fecha de Última Visita al Médico: </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Fecha" class="span2 calendario" style="width:100px" id="ultima_visita_medico" name="ultima_visita_medico" value="<?php echo $Datos_Formato['Ultima_Visita_Medico']; ?>"> </div>
                <div class="span1"> <label><strong> Motivo: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:105%;" placeholder="Tratamiento" id="motivo_1" name="motivo_1"><?php echo $Datos_Formato['Motivo_1']; ?></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Estado de Salud Oral: </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Estado de Salud Oral" style="width:300%" id="estado_salud_oral" name="estado_salud_oral" value="<?php echo $Datos_Formato['Estado_Salud_Oral']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Problema Principal: </strong></label> </div>
                <div class="span2.5"> <input type="text" placeholder="Problema Principal" style="width:100%px" id="problema_principal_2" name="problema_principal_2" value="<?php echo $Datos_Formato['Problema_Principal_2']; ?>"> </div>
                <div class="span1"> <label><strong> Tratamiento: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:100%;" placeholder="Tratamiento" id="tratamiento_2" name="tratamiento_2"><?php echo $Datos_Formato['Tratamiento_2']; ?></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Otros: </strong></label> </div>
                <div class="span3"> <input type="text" placeholder="Otros" style="width:110%" id="otros" name="otros" value="<?php echo $Datos_Formato['Otros']; ?>"> </div>
                <div class="span1" style="padding-left:45px;"> <label><strong> Tratamiento: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:100%;" placeholder="Tratamiento" id="tratamiento_3" name="tratamiento_3"><?php echo $Datos_Formato['Tratamiento_3']; ?></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Fecha de Última Visita al Dentista: </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Fecha" class="span2 calendario" style="width:100px" id="ultima_visita_dentista" name="ultima_visita_dentista" value="<?php echo $Datos_Formato['Ultima_Visita_Dentista']; ?>"> </div>
                <div class="span1"> <label><strong> Motivo: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:105%;" placeholder="Tratamiento" id="motivo_2" name="motivo_2"><?php echo $Datos_Formato['Motivo_2']; ?></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Motivo por el Cual Perdió sus Piezas: </strong></label> </div>
              </div>
              <div class="row"> 
                <div class="span1.5"> <input type="radio" id="motivo_perdida_piezas" name="motivo_perdida_piezas" value="1" <?php echo ($Datos_Formato['Motivo_Perdia_Piezas'] == "1" ? "checked":""); ?>> Caries </div>
                <div class="span2.5"> <input type="radio" id="motivo_perdida_piezas" name="motivo_perdida_piezas" value="2" <?php echo ($Datos_Formato['Motivo_Perdia_Piezas'] == "2" ? "checked":""); ?>> Enfermedad Periodontal </div>
                <div class="span1.5"> <input type="radio" id="motivo_perdida_piezas" name="motivo_perdida_piezas" value="3" <?php echo ($Datos_Formato['Motivo_Perdia_Piezas'] == "3" ? "checked":""); ?>> Trauma </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Tiene o ha Tenido Prótesis: </strong></label> </div>
              </div>
              <div class="row"> 
                <div class="span1.5"> <input type="radio" id="tiene_protesis" name="tiene_protesis" value="1" <?php echo ($Datos_Formato['Tiene_Protesis'] == "1" ? "checked":""); ?>> Pobre </div>
                <div class="span1.5"> <input type="radio" id="tiene_protesis" name="tiene_protesis" value="2" <?php echo ($Datos_Formato['Tiene_Protesis'] == "2" ? "checked":""); ?>> Regular </div>
                <div class="span1.5"> <input type="radio" id="tiene_protesis" name="tiene_protesis" value="3" <?php echo ($Datos_Formato['Tiene_Protesis'] == "3" ? "checked":""); ?>> Buena </div>
              </div>
            </div><!-- fin tab2 -->

            <div class="tab-pane" id="tab3">
              <h2>Características de los Dientes</h2>
              <br />
              <div class="row"> 
                <div class="span1"> <label><strong> Forma </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Forma" style="width:100%;" id="forma_1" name="forma_1" value="<?php echo $Datos_Formato['Forma_1']; ?>"> </div>
                <div class="span1"> <label><strong> Color </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Color" style="width:100%" id="color_1" name="color_1" value="<?php echo $Datos_Formato['Color_1']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Tamaño </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Tamaño" style="width:100%;" id="tamano_1" name="tamano_1" value="<?php echo $Datos_Formato['Tamano_1']; ?>"> </div>
                <div class="span1"> <label><strong> Posición </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Posición" style="width:100%" id="posicion" name="posicion" value="<?php echo $Datos_Formato['Posicion']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span1"> <label><strong> Vitalidad Pulpar </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Vitalidad Pulpar" style="width:100%;" id="vitalidad_pulpar" name="vitalidad_pulpar" value="<?php echo $Datos_Formato['Vitalidad_Pulpar']; ?>"> </div>
              </div>
              <h3>Características de los Maxilares</h3>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Forma </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Forma" style="width:100%;" id="forma_2" name="forma_2" value="<?php echo $Datos_Formato['Forma_2']; ?>"> </div>
                <div class="span1"> <label><strong> Tamaño </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Tamaño" style="width:100%" id="tamano_2" name="tamano_2" value="<?php echo $Datos_Formato['Tamano_2']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2"> <label><strong> Relación Intermaxilar </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Relación Intermaxilar" style="width:100%;" id="relacion_intermaxilar" name="relacion_intermaxilar" value="<?php echo $Datos_Formato['Relacion_Intermaxilar']; ?>"></div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2"> <label><strong> Procesos Residuales </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Procesos Residuales" style="width:100%;" id="procesos_residuales" name="procesos_residuales" value="<?php echo $Datos_Formato['Procesos_Residuales']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Forma de Bóveda Palatina </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Forma de Bóveda Palatina" style="width:100%;" id="forma_boveda_palatina" name="forma_boveda_palatina" value="<?php echo $Datos_Formato['Forma_Boveda_Palatina']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Presencia de Torus </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Presencia de Torus" style="width:100%;" id="presencia_torus" name="presencia_torus" value="<?php echo $Datos_Formato['Presencia_Torus']; ?>"> </div>
              </div>
              <h3>Características de la Mucosa</h3>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Color </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Color" style="width:100%;" id="color_2" name="color_2" value="<?php echo $Datos_Formato['Color_2']; ?>"> </div>
                <div class="span1"> <label><strong> Consistencia </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Consistencia" style="width:100%" id="consistencia" name="consistencia" value="<?php echo $Datos_Formato['Consistencia']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Espesor </strong></label> </div>
                <div class="span2.5"> <input type="text" placeholder="Espesor" style="width:100%;" id="espesor" name="espesor" value="<?php echo $Datos_Formato['Espesor']; ?>"> </div>
                <div class="span2"> <label><strong> Altura a Nivel de Piezas </strong></label> </div>
                <div class="span3"> <input type="text" placeholder="Altura a Nivel de Piezas" style="width:100%;" id="altura_nivel_piezas" name="altura_nivel_piezas" value="<?php echo $Datos_Formato['Altura_Nivel_Piezas']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2"> <label><strong> Frenillos </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Frenillos" style="width:100%;" id="frenillos" name="frenillos" value="<?php echo $Datos_Formato['Frenillos']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Condiciones del Periodonto </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Condiciones del Periodonto" style="width:100%;" id="condiciones_periodonto" name="condiciones_periodonto" value="<?php echo $Datos_Formato['Condiciones_Periodonto']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Movilidad Dental </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Movilidad Dental" style="width:100%;" id="movilidad_dental" name="movilidad_dental" value="<?php echo $Datos_Formato['Movilidad_Dental']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> I.H.O.S. </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="I.H.O.S." style="width:100%;" id="ihos" name="ihos" value="<?php echo $Datos_Formato['IHOS']; ?>"> </div>
              </div>
               <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Clasificación de la Brecha </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Clasificación de la Brecha" style="width:100%;" id="clasificacion_brecha" name="clasificacion_brecha" value="<?php echo $Datos_Formato['Clasificacion_Bracha']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Hallazgos </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Hallazgos" style="width:100%;" id="hallazgos" name="hallazgos" value="<?php echo $Datos_Formato['Hallazgos']; ?>"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Estudio Radiográfico </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Estudio Radiográfico" style="width:100%;" id="estudio_radiografico" name="estudio_radiografico" value="<?php echo $Datos_Formato['Estudio_Radiografico']; ?>"> </div>
              </div>
            </div><!-- fin tab4 -->
        ...
        <div align="row">
          ...
          <a href="../clinica/formatohistoriaclinicaprotesisparcialremovible.php" class="btn btn-danger pull-right cancelar"> Cancelar</a>
        </div>
		<?php endif; ?>
      ...
      <input type="hidden" id="ventana" value="formato-historia-clinica-protesis-parcial-removible">
