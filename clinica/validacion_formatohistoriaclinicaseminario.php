...
include("../core-saec/Formato_Historia_Clinica_Seminario.php");
...
if(isset($_REQUEST['guardar']))
{
    ...
    $Paciente = $_POST["sltpaciente-seminario"];
    ...
    $Hiptertension = $_POST["hipertension"];
    $Hipotension = $_POST["hipotension"];
    $Convulsiones = $_POST["convulsiones"];
    $Artritis = $_POST["artritis"];
    $Problemas_Alergia = $_POST["problemas_alergia"];
    $Problemas_Hemorragicos = $_POST["problemas_hemorragicos"];
    ...
    $Anestesico_Indicado = $_POST["anestesico_indicado"];
    $Condiciones_Tejidos_Blandos = $_POST["condiciones_tejidos_blandos"];
    $Condiciones_Oseas = $_POST["condiciones_oseas"];
    $Condiciones_Proceso_Alveolar = $_POST["condiciones_proceso_alveolar"];
    $Condiciones_ATM = $_POST["condiciones_atm"];
    $Condiciones_Oclusion = $_POST["condiciones_oclusion"];
    $Condiciones_Periodonto = $_POST["condiciones_periodonto"];
    $Presencia_PDB = $_POST["presencia_pdb"];
    $Calculo_Dental_Supragingival = $_POST["calculo_dental_supragingival"];
    $Calculo_Dental_Subgingival = $_POST["calculo_dental_subgingival"];
    $Necesidades_Radiologicas = $_POST["necesidades_radiologicas"];
    $Necesidades_Modelo_Estudio = $_POST["necesidades_modelo_estudio"];
    ...
    $Formato_Historia_Clinica_Seminario = new Formato_Historia_Clinica_Seminario(
        ...
        $Diagnostico_Medico,
        $Anestesico_Indicado,
        $Condiciones_Tejidos_Blandos,
        $Condiciones_Oseas,
        $Condiciones_Proceso_Alveolar,
        $Condiciones_ATM,
        $Condiciones_Oclusion,
        $Condiciones_Periodonto,
        $Presencia_PDB,
        $Calculo_Dental_Supragingival,
        $Calculo_Dental_Subgingival,
        $Necesidades_Radiologicas,
        $Necesidades_Modelo_Estudio,
        $Diente_18, 
        $Diente_17,
        $Diente_16,
        $Diente_15,
    ...
    $Formato_Historia_Clinica_Seminario->Alta();
} 
...
if(isset($_REQUEST['aprobar']))
{
    ...
    $Formato_Historia_Clinica_Seminario->IdHistoriaClinicaSeminario = $Historia_Clinica;
    $Formato_Historia_Clinica_Seminario->Aprobado = $Aprobado;
    
    $Formato_Historia_Clinica_Seminario->Aprobar();
}
?>