        ...
        <?php 
                ...
                if($SIS_Datos_Usuario['NombrePuesto'] == 'Administrador'){
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Administrador_Reporte($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Administrador_Reporte();
                    endif;
                }
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Medico_Titular_Reporte($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Medico_Titular_Reporte();
                    endif;
                }
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Alumno_Op_As_Reporte($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Alumno_Op_As_Reporte();
                    endif;
                }
              ?>  
        </tbody>
