...
<script src="validacion_formatohistoriaclinicaseminario.js"></script>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <form method="post" action="validacion_formatohistoriaclinicaseminario.php" onsubmit="return validacion()">
            ...
            <div class="tab-pane active" id="tab1">
              ...
              <div class="row"> 
                <div class="span3"> 
                  ...
                  <select class="input-block-level2" id="sltpaciente-seminario" name="sltpaciente-seminario">
	          ...
	          <input type="text" name="telefono" style="width:100%;" value="<?php echo (isset($_GET['paciente']) ? $Datos_Paciente['Telefono']:""); ?>" placeholder="Teléfono">
		</div>
              </div>
              <br>
              <div class="row"> 
	           ...
	           <input type="text" name="calle" style="width:100%;" value="<?php echo (isset($_GET['paciente']) ? $Datos_Paciente['Calle']:""); ?>" placeholder="Calle">
		</div>
	        <div class="span1"> 
	           <label><strong> Número: </strong></label>
	           <input type="text" name="numero" style="width:100%;" value="<?php echo (isset($_GET['paciente']) ? $Datos_Paciente['Numero']:""); ?>" placeholder="Número">
		</div>
              </div>
	      <br>
              <div class="row"> 
	           ...
	           <input type="text" name="colonia" style="width:100%;" value="<?php echo (isset($_GET['paciente']) ? $Datos_Paciente['Colonia']:""); ?>" placeholder="Colonia">
		</div>
	        <div class="span2"> 
	           <label><strong> Población: </strong></label>
	           <input type="text" name="poblacion" style="width:100%;" value="<?php echo (isset($_GET['paciente']) ? $Datos_Paciente['Poblacion']:""); ?>" placeholder="Población">
		</div>
              </div>
            </div><!-- fin tab1 -->
            <div class="tab-pane" id="tab2">
                ...
                <tbody>
                  <tr>
                    ...
                    <td style="width:100px;">
                        <input type="radio" id="diabetes" name="diabetes" value="1"> Si</td>
                    <td><input type="radio"id="diabetes" name="diabetes" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Cardiopatías</strong></td>
                    <td><input type="radio" id="cardiopatias" name="cardiopatias" value="1"> Si</td>
                    <td><input type="radio" id="cardiopatias" name="cardiopatias" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Hipertensión</strong></td>
                    <td><input type="radio" id="hipertension" name="hipertension" value="1"> Si</td>
                    <td><input type="radio" id="hipertension" name="hipertension" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Hipotensión</strong></td>
                    <td><input type="radio" id="hipotension" name="hipotension" value="1"> Si</td>
                    <td><input type="radio" id="hipotension" name="hipotension" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Convulsiones</strong></td>
                    <td><input type="radio" id="convulsiones" name="convulsiones" value="1"> Si</td>
                    <td><input type="radio" id="convulsiones" name="convulsiones" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Artritis</strong></td>
                    <td><input type="radio" id="artritis" name="artritis" value="1"> Si</td>
                    <td><input type="radio" id="artritis" name="artritis" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Problemas de Alergia</strong></td>
                    <td><input type="radio" id="problemas_alergia" name="problemas_alergia" value="1"> Si</td>
                    <td><input type="radio" id="problemas_alergia" name="problemas_alergia" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Problemas Hemorrágicos</strong></td>
                    <td><input type="radio"  id="problemas_hemorragicos" name="problemas_hemorragicos" value="1"> Si</td>
                    <td><input type="radio" id="problemas_hemorragicos" name="problemas_hemorragicos" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Hepatitis</strong></td>
                    <td><input type="radio" id="hepatitis" name="hepatitis" value="1"> Si</td>
                    <td><input type="radio" id="hepatitis" name="hepatitis" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Sida</strong></td>
                    <td><input type="radio" id="sida" name="sida" value="1"> Si</td>
                    <td><input type="radio" id="sida" name="sida" value="2" checked> No</td>
                  </tr>
                  <tr>
                    <td><strong>Tuberculosis</strong></td>
                    <td><input type="radio" id="tuberculosis" name="tuberculosis" value="1"> Si</td>
                    <td><input type="radio" id="tuberculosis" name="tuberculosis" value="2" checked> No</td>
                  </tr>
                </tbody>
              </table>
              <br>
              <div class="row"> 
                ...
                <div class="span1.5">
                    <input type="radio" id="pregunta_1" name="pregunta_1" value="1"> Si 
                </div>
                <div class="span1.5">
                    <input type="radio" id="pregunta_1" name="pregunta_1" value="2" checked> No 
                </div>
              </div>
              <br>
              <div class="row"> 
              ...
              <div>
                <div class="span1.5"> <input type="radio" id="pregunta_2" name="pregunta_2" value="1" checked> Primero </div>
                <div class="span1.5"> <input type="radio" id="pregunta_2" name="pregunta_2" value="2"> Segundo </div>
                <div class="span1.5"> <input type="radio" id="pregunta_2" name="pregunta_2" value="3"> Tercero </div>
              </div>
              <br><br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> ¿Actualmente esta tomando algún Medicamento? </strong></label> </div>
                <div class="span1.5"> <input type="radio" id="pregunta_3" name="pregunta_3" value="1"> Si </div>
                <div class="span1.5"> <input type="radio" id="pregunta_3" name="pregunta_3" value="2" checked> No </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> En caso afirmativo, ¿Cuál? </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="En caso afirmativo, ¿Cuál?" style="width:250%" id="cual_medicamento" name="cual_medicamento"></div>
              </div>
              <br>
              <div class="row">
                <div class="span1.5"> <label><strong> Presión Arterial: </strong></label> </div>
                <div class="span2.5"> <input type="text" placeholder="Presión Arterial" id="presion_arterial" name="presion_arterial"> </div>
                <div class="span0.5"> <label><strong> Pulso: </strong></label> </div>
                <div class="span2"> <input type="text" placeholder="Pulso" id="pulso" name="pulso"> </div>
              </div>
              <br>
              <div class="row">
                <div class="span1.5"> <label><strong> Temperatura: </strong></label> </div>
                <div class="span2.5"> <input type="text" placeholder="Temperatura" id="temperatura" name="temperatura"> </div>
              </div>
              <br>
              <div class="row">
                <div class="span1.5"> <label><strong> Diagnóstico Médico: </strong></label> </div>
                <div class="span6"> <textarea rows="3" col="10" style="width:100%;" placeholder="Diagnóstico Médico" id="diagnostico_medico" name="diagnostico_medico"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span1.5"> <label><strong> Anestésico Indicado: </strong></label> </div>
                <div class="span2.5"> <input type="text" placeholder="Anestésico Indicado" style="width:275%;" id="anestesico_indicado" name="anestesico_indicado"> </div>
              </div>
            </div><!-- fin tab2 -->
            <div class="tab-pane" id="tab3">
              ...
              <div class="row">
                ...
                <div class="span6"> <textarea rows="3" col="10" style="width:90%;" placeholder="Condiciones de Tejidos Blandos" id="condiciones_tejidos_blandos" name="condiciones_tejidos_blandos"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2"> <label><strong> Condiciones Óseas </strong></label> </div>
                <div class="span6"> <textarea rows="3" col="10" style="width:90%;" placeholder="Condiciones Óseas" id="condiciones_oseas" name="condiciones_oseas"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2"> <label><strong> Condiciones del Proceso Alveolar </strong></label> </div>
                <div class="span6"> <textarea rows="3" col="10" style="width:90%;" placeholder="Condiciones del Proceso Alveolar" id="condiciones_proceso_alveolar" name="condiciones_proceso_alveolar"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2"> <label><strong> Condiciones de la A.T.M. </strong></label> </div>
                <div class="span6"> <textarea rows="3" col="10" style="width:90%;" placeholder="Condiciones de la A.T.M." id="condiciones_atm" name="condiciones_atm"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2"> <label><strong> Condiciones de la Oclusión </strong></label> </div>
                <div class="span6"> <textarea rows="3" col="10" style="width:90%;" placeholder="Condiciones de la Oclusión" id="condiciones_oclusion" name="condiciones_oclusion"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2"> <label><strong> Condiciones del Periodonto </strong></label> </div>
                <div class="span6"> <textarea rows="3" col="10" style="width:90%;" placeholder="Condiciones del Periodonto" id="condiciones_periodonto" name="condiciones_periodonto"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span1.5"> <label><strong> Presencia de PDB </strong></label> </div>
                <div class="span1"> <input type="text" style="width:50px;" id="presencia_pdb" name="presencia_pdb"> </div>
                <div class="span2.5"> <label><strong> Cálculo Dental Supragingival </strong></label> </div>
                <div class="span3"> <input type="text" style="width:50px;" id="calculo_deltal_supragingival" name="calculo_dental_supragingival"> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2.5"> <label><strong> Cálculo Dental Subgingival </strong></label> </div>
                <div class="span3"> <input type="text" style="width:50px;" id="calculo_dental_subgingival" name="calculo_dental_subgingival"> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2"> <label><strong> Necesidades Radiológicas </strong></label> </div>
                <div class="span6"> <textarea rows="3" col="10" style="width:90%;" placeholder="Necesidades Radiológicas" id="necesidades_radiologicas" name="necesidades_radiologicas"></textarea> </div>
              </div>
              <br>
              <div class="row">
                <div class="span2"> <label><strong> Necesidades de Modelos de Estudio </strong></label> </div>
                <div class="span6"> <input type="text" placeholder="Necesidades de Modelos de Estudio" style="width:50%;" id="necesidades_modelo_estudio" name="necesidades_modelo_estudio"> </div>
              </div>
            </div>
