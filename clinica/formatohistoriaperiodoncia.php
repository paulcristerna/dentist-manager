    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <?php if($SIS_Datos_Usuario['NombrePuesto'] == "Alumno Operador/Asistente"): ?>
          <a href="../clinica/formatohistoriaperiodoncia-nuevo.php" class="btn btn-institucional pull-left">
            <i class="icon-plus-sign icon-white"></i> Llenar Nuevo Formato Historia Periodoncia
          </a>
        <?php endif; ?>

          <div class="input-append pull-right">
            <form method="get" action="formatohistoriaperiodoncia.php">
		  ...
		  <?php endif; ?>
           ...
           <div class="row">
            <div class="span9">
               <a href="reportes/formatoshistoriaperiodoncia-generar-pdf.php?buscar=<?php echo (isset($_GET['buscar']) ? $_GET['buscar']:"") ?>" class="btn btn-institucional pull-right" target="_blank">Generar Reporte</a>
            </div>
          </div>
              ...
              <?php 
                ...
                if($SIS_Datos_Usuario['NombrePuesto'] == 'Administrador'){
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Administrador($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Administrador();
                    endif;
                }
                    ...
                    $Formato_Historia_Clinica_Periodoncia->IdParejaClinica = $DatosParejaClinica['IdParejaClinica'];
                    
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Medico_Titular($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Medico_Titular();
                    endif;
                }
                    ...
                    if(isset($_GET['buscar'])):
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Alumno_Op_As($_GET['buscar']);
                    else:
                        $Formato_Historia_Clinica_Periodoncia->Catalogo_Alumno_Op_As();
                    endif;
                }
              ?>    
            </tbody>
