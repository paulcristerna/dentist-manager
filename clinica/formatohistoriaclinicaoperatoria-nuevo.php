...
<script src="validacion_formatohistoriaclinicaoperatoria.js"></script>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <form method="post" action="validacion_formatohistoriaclinicaoperatoria.php" onsubmit="return validacion()">
            ...
            <div class="tab-pane active" id="tab1">
              ...
              <div class="row"> 
                <div class="span3">
                    ...
                    <select class="input-block-level2" id="sltpaciente-operatoria" name="sltpaciente-operatoria">
		...
		<div class="span1"> 
	            ...
	            <?php echo (isset($_GET['paciente']) ? $Datos_Paciente['Sexo']:""); ?>
                </div>
              </div>
              <br>
              <div class="row"> 
	      ...
	      <div class="row"> 
	        ...
	        <div class="span2"> 
              ...
              <div class="row"> 
                ...
                <div class="span3.5"> <input type="text" placeholder="¿Cuál es el motivo de la consulta?" style="width:350px;" id="motivo_consulta" name="motivo_consulta"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2.5"> <label><strong> ¿Se encuentra bajo Tx médico? </strong></label> </div>
                <div class="span3.5"  style="padding-left:20px;"> <input type="text" placeholder="¿Se encuentra bajo Tx médico?" style="width:350px;" id="tx_medico" name="tx_medico"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2.5"> <label><strong> Observaciones Radiológicas </strong></label> </div>
                <div class="span3.5"  style="padding-left:40px;"> <input type="text" placeholder="Observaciones Radiológicas" style="width:350px;" id="observaciones_radiologicas" name="observaciones_radiologicas"> </div>
              </div>
            </div><!-- fin tab1 -->
	      ...
	      <table class="table table-striped tabla-centrada">                
            ...
            <div class="tab-pane" id="tab3">
              ...
              <div class="row">
                ...
                <tbody>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_1" name="restauracion_tipo_pieza_1"></center></td>
                    <td><center><input type="text" id="recibo_numero_1" name="recibo_numero_1"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_2" name="restauracion_tipo_pieza_2"></center></td>
                    <td><center><input type="text" id="recibo_numero_2" name="recibo_numero_2"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_3" name="restauracion_tipo_pieza_3"></center></td>
                    <td><center><input type="text" id="recibo_numero_3" name="recibo_numero_3"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_4" name="restauracion_tipo_pieza_4"></center></td>
                    <td><center><input type="text" id="recibo_numero_4" name="recibo_numero_4"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_5" name="restauracion_tipo_pieza_5"></center></td>
                    <td><center><input type="text" id="recibo_numero_5" name="recibo_numero_5"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_6" name="restauracion_tipo_pieza_6"></center></td>
                    <td><center><input type="text" id="recibo_numero_6" name="recibo_numero_6"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_7" name="restauracion_tipo_pieza_7"></center></td>
                    <td><center><input type="text" id="recibo_numero_7" name="recibo_numero_7"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_8" name="restauracion_tipo_pieza_8"></center></td>
                    <td><center><input type="text" id="recibo_numero_8" name="recibo_numero_8"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_9" name="restauracion_tipo_pieza_9"></center></td>
                    <td><center><input type="text" id="recibo_numero_9" name="recibo_numero_9"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_10" name="restauracion_tipo_pieza_10"></center></td>
                    <td><center><input type="text" id="recibo_numero_10" name="recibo_numero_10"></center></td>
                  </tr>
                </tbody>
              </table>
                </div>  
              ...
              <div class="row">
                <div class="span6"><textarea rows="3" cols="10" style="width:105%;" placeholder="Observaciones" id="observaciones" name="observaciones"></textarea> </div> 
              </div>
            </div><!-- fin tab3 -->
        </div><!-- fin tabcontent -->
