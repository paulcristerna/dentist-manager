<?php include("../header2.php"); ?>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <h2>Formato de Historia Clínica de Operatoria</h2>
            
        <form method="post" action="validacion_formatohistoriaclinicaoperatoria.php">
         ...
         <?php 
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab1">
              ...
              <input type="hidden" value="<?php echo $_GET['formato']; ?>" name="pareja-clinica" id="pareja-clinica">
              <br>
              <div class="row"> 
                <div class="span5">
                    <label><strong>Paciente:</strong>                                   <?php echo $Datos_Formato['NombrePaciente'].' '.$Datos_Formato['ApellidoPaternoPaciente'].' '.$Datos_Formato['ApellidoMaternoPaciente']; ?></label>
                </div>
                </div>
                <div class="row"> 
                    <br />
              ...
              <div class="row"> 
                ...
                <div class="span1.5"> <label><strong>Teléfono:</strong> <?php echo $Datos_Formato['TelefonoPaciente']; ?></label> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Domicilio: </strong> <?php echo $Datos_Formato['CallePaciente'].', '.$Datos_Formato['NumeroPaciente'].', '.$Datos_Formato['ColoniaPaciente'].'. '.$Datos_Formato['PoblacionPaciente']; ?></label></div>
                <div class="span0.5"> <label><strong>Fecha: </strong> <?php echo $fecha_registro; ?></label></div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2.5"> <label><strong> ¿Cuál es el motivo de la consulta? </strong></label> </div>
                <div class="span3.5"> <input type="text" placeholder="¿Cuál es el motivo de la consulta?" style="width:350px;" id="motivo_consulta" name="motivo_consulta" value="<?php echo $Datos_Formato['Motivo_Consulta']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2.5"> <label><strong> ¿Se encuentra bajo Tx médico? </strong></label> </div>
                <div class="span3.5"  style="padding-left:20px;"> <input type="text" placeholder="¿Se encuentra bajo Tx médico?" style="width:350px;" id="tx_medico" name="tx_medico" value="<?php echo $Datos_Formato['TX_Medico']; ?>"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2.5"> <label><strong> Observaciones Radiológicas </strong></label> </div>
                <div class="span3.5"  style="padding-left:40px;"> <input type="text" placeholder="Observaciones Radiológicas" style="width:350px;" id="observaciones_radiologicas" name="observaciones_radiologicas" value="<?php echo $Datos_Formato['Observaciones_Radiologicas']; ?>"> </div>
              </div>
            </div><!-- fin tab1 -->
	      ...
	      <table class="table table-striped tabla-centrada">                
            ...
            <div class="tab-pane" id="tab3">
              ...
              <div class="row">
                ...
                <tbody>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_1" name="restauracion_tipo_pieza_1" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_1']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_1" name="recibo_numero_1" value="<?php echo $Datos_Formato['Recibo_Numero_1']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_2" name="restauracion_tipo_pieza_2" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_2']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_2" name="recibo_numero_2" value="<?php echo $Datos_Formato['Recibo_Numero_2']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_3" name="restauracion_tipo_pieza_3" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_3']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_3" name="recibo_numero_3" value="<?php echo $Datos_Formato['Recibo_Numero_3']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_4" name="restauracion_tipo_pieza_4" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_4']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_4" name="recibo_numero_4" value="<?php echo $Datos_Formato['Recibo_Numero_4']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_5" name="restauracion_tipo_pieza_5" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_5']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_5" name="recibo_numero_5" value="<?php echo $Datos_Formato['Recibo_Numero_5']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_6" name="restauracion_tipo_pieza_6" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_6']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_6" name="recibo_numero_6" value="<?php echo $Datos_Formato['Recibo_Numero_6']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_7" name="restauracion_tipo_pieza_7" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_7']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_7" name="recibo_numero_7" value="<?php echo $Datos_Formato['Recibo_Numero_7']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_8" name="restauracion_tipo_pieza_8" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_8']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_8" name="recibo_numero_8" value="<?php echo $Datos_Formato['Recibo_Numero_8']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_9" name="restauracion_tipo_pieza_9" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_9']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_9" name="recibo_numero_9" value="<?php echo $Datos_Formato['Recibo_Numero_9']; ?>"></center></td>
                  </tr>
                  <tr> 
                    <td><center><input type="text" id="restauracion_tipo_pieza_10" name="restauracion_tipo_pieza_10" value="<?php echo $Datos_Formato['Restauracion_Tipo_Pieza_10']; ?>"></center></td>
                    <td><center><input type="text" id="recibo_numero_10" name="recibo_numero_10" value="<?php echo $Datos_Formato['Recibo_Numero_10']; ?>"></center></td>
                  </tr>
                </tbody>
              </table>
                </div>  
              ...
              <div class="row">
                <div class="span6"><textarea rows="3" cols="10" style="width:105%;" placeholder="Observaciones" id="observaciones" name="observaciones"><?php echo $Datos_Formato['Observaciones']; ?></textarea> </div> 
              </div>
            </div><!-- fin tab3 -->
        </div><!-- fin tabcontent -->
        ...
        <div align="row">
          ...
          <a href="../clinica/formatohistoriaclinicaoperatoria.php" class="btn btn-danger pull-right cancelar"> Cancelar</a>
        </div>
		<?php endif; ?>
