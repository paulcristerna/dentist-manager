    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <div class="span9">
          ...
          <a href="../almacen/proveedor-nuevo.php" class="btn btn-institucional pull-left"><i class="icon-plus-sign icon-white"></i> Agregar Proveedor</a>
          ...
          <div class="row">
            <div class="span9">
                <a href="reportes/proveedores-generar-pdf.php?buscar=<?php echo (isset($_GET['buscar']) ? $_GET['buscar']:""); ?>" class="btn btn-institucional pull-right" target="_blank">Generar Reporte</a>
            </div>
          </div>
            ...
            <tbody>
              <?php
                ...
                if(isset($_GET['buscar'])):
                    $Proveedor->Catalogo_Proveedores($_GET['buscar']);
                else:
