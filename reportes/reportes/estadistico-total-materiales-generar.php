    ...
    <table id="cabecera">
      <tr>
        ...
        <td style="width:470px;">
          <h4>Reporte Estadistico Total de Materiales</h4>
      ...
      <?php 
        ...
        $Reporte = new Reporte('',$FechaInicio,$FechaFin,$Departamento,$Comunidad);
      ...
      <?php $Reporte->Generar_Estadistico_Total_Materiales(); ?>
  </div>
</body>
</html>
