...
include("../core-saec/Formato_Historia_Clinica_Comunitaria.php");
...
if(isset($_REQUEST['guardar']))
{
    ...
    $Paciente = $_POST["sltpaciente-comunitaria"];
    $Calle = $_POST["calle"];
    $Numero = $_POST["numero"];
    ...
    $PadecimientoActual = $_POST["padecimiento-actual"];
    $Temperatura = $_POST["padecimiento-actual"];
    $Pulso = $_POST["pulso"];
    $PresionArterial = $_POST["presion-arterial"];
    ...
    $Pregunta12 = $_POST["pregunta-12"];
    $Pregunta13 = $_POST["pregunta-13"];
    $Pregunta14 = $_POST["pregunta-14"];
    $Cara = $_POST["cara"];
    $Labios = $_POST["labios"];
    $MucosaBucal = $_POST["mucosa-bucal"];
    $Lengua = $_POST["lengua"];
    $PisoBoca = $_POST["piso-boca"];
    $GangliosLinfaticos = $_POST["ganglios-linfaticos"];
    $PaladarDuro = $_POST["paladar-duro"];
    $PaladarBlando = $_POST["paladar-blando"];
    $BucoFaringe = $_POST["buco-faringe"];
    $Encia = $_POST["encia"];
    ...
    $PlanTratamiento = $_POST["plan-tratamiento"];
    ...
    $Formato_Historia_Clinica_Comunitaria->Alta();   
}
