...
<head>
  <meta charset="utf-8">
  <title>Reporte de Total de Pacientes de Historias Clínicas</title>
  <style type="text/css">
    table th, td{
      text-align: center;
    }
...
<body>
  <div id="contenedor">
    <table id="cabecera">
      <tr>
        ...
        <td style="width:470px;">
          <h4>Reporte de Total de Pacientes de Historias Clínicas</h4>
      ...
      <?php
        ...
        $IdDepartamento = $_GET['clinica'];
        $IdComunidad = $_GET['comunidad'];
        $IdMateria = $_GET['materia'];
        $Sexo = (isset($_GET['sexo']) ? $_GET['sexo']:"");
        $EdadInicio = $_GET['edad-inicio'];
        $EdadFin = $_GET['edad-fin'];

        $Reporte = new Reporte('',$FechaInicio,$FechaFin,$IdDepartamento,$IdComunidad,$IdMateria,$Sexo,$EdadInicio,$EdadFin);
    ...
    <?php $Reporte->Generar_Total_Pacientes_Historias_Clinicas(); ?>
</body>
</html>
