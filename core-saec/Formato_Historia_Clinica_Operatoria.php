<?php class Formato_Historia_Clinica_Operatoria extends AccesoBD
	{
		public $IdHistoriaClinicaOperatoria;
		...
		(
			$varIdHistoriaClinicaOperatoria = null,
		...
		{
			$this->IdHistoriaClinicaOperatoria = $varIdHistoriaClinicaOperatoria;
		...
		//catalogo de formatos de historias clinicas de operatoria en modo administrador
		...
		public function Catalogo_Administrador($Buscar=null)
		{
            ...
            if($Buscar==null):
                $SQL = "SELECT  *
                        FROM SIS_Listado_Historia_Clinica_Operatoria;";
            else:
                $SQL = "SELECT  *
                        FROM SIS_Listado_Historia_Clinica_Operatoria
			...
			if($Num_Filas > 0):?>
				<?php while($Linea = mysqli_fetch_array($Resultado, MYSQL_ASSOC)): ?>
					<tr>
						...
						<td><a href="formatohistoriaclinicaoperatoria-ver.php?formato=<?php echo $Linea['IdHistoriaClinicaOperatoria']; ?>" class="btn btn-institucional">Ver Historia Clínica</a></td>									<td><a href="reportes/formatohistoriaclinicaoperatoria-generar-pdf.php?formato=<?php echo $Linea['IdHistoriaClinicaOperatoria']; ?>" class="btn btn-institucional" target="blank">Generar PDF</a></td>
					</tr>
				<?php endwhile; ?>
			<?php else: ?>
				<tr>
					<td colspan="3"><?php echo ($Buscar == null ? "No hay formatos de historias clinicas operatoria registradas todavía.":"No se encontro ningún formato de historias clinicas operatoria en la busqueda."); ?></td>
				</tr>
			<?php endif;			
		...
		//catalogo de formatos de historias clinicas de operatoria en modo medico titular
			...
			if($Num_Filas > 0):?>
				<?php while($Linea = mysqli_fetch_array($Resultado)): ?>
					<tr>
						...
						<td><?php echo $Linea['NombreAlumnoOpAs1'].' '.$Linea['ApellidoPaternoAlumnoOpAs1'].' '.$Linea['ApellidoPaternoAlumnoOpAs1']; ?> y
                            <?php echo $Linea['NombreAlumnoOpAs2'].' '.$Linea['ApellidoPaternoAlumnoOpAs2'].' '.$Linea['ApellidoPaternoAlumnoOpAs2']; ?></td>
                        <td><a href="formatohistoriaclinicaoperatoria-ver.php?formato=<?php echo $Linea['IdHistoriaClinicaOperatoria']; ?>" class="btn btn-institucional">Ver Historia Clínica</a></td>
			<td><a href="reportes/formatohistoriaclinicaoperatoria-generar-pdf.php?formato=<?php echo $Linea['IdHistoriaClinicaOperatoria']; ?>" class="btn btn-institucional" target="blank">Generar PDF</a></td>
					</tr>
				<?php endwhile; ?>
			<?php else: ?>
				<tr>
		...
		//catalogo de formatos de historias clinicas de operatoria en modo alumno operador/asistente
		...
		//dar de alta un formato de historia clinica de operatoria
        ...
        public function Alta()
		{
            ...
            // realizar la consulta
			$SQL = "CALL Formato_Historia_Clinica_Operatoria_Alta(
			...
			{   
				...
				$Bitacora = new Bitacora("realizo el llenado de una historia clinica de operatoria",3);
				$Bitacora->Entrada_Bitacora();
				
                //redireccionar al usuario                
                header('Location: formatohistoriaclinicaoperatoria.php?exito=Se guardo la historia clinica con exito');
			}else{
                header('Location: formatohistoriaclinicaoperatoria.php?error=Ocurrio un error. '.mysqli_error($Conexion));
			}
		...
		//catalogo de formatos de historias clinicas de operatoria en reportes en modo administrador
		...
		public function Catalogo_Administrador_Reporte($Buscar=null)
		{
			...
			<?php else: ?>
				<tr>
					<td colspan="2"><?php echo ($Buscar == null ? "No hay formatos de historias clinicas operatoria registradas todavía.":"No se encontro ningún formato de historias clinicas operatoria en la busqueda."); ?></td>
				</tr>
			<?php endif;			
		...
		//catalogo de formatos de historias clinicas de operatoria en reportes en modo medico titular
		...
		//catalogo de formatos de historias clinicas de operatoria en reportes en modo alumno operador/asistente
		...
		//obtener datos de un formato de historia clinica de operatoria
        ...
        public function Obtener_Formato($Buscar=null)
		{
			...
			$SQL = "SELECT  *
					FROM SIS_Listado_Historia_Clinica_Operatoria
					WHERE IdHistoriaClinicaOperatoria = '$this->IdHistoriaClinicaOperatoria';";
		...
		//aprobar un formato de historia clinica de operatoria
        ...
        public function Aprobar()
		{
			...
			// realizar la consulta
			$SQL = "CALL Formato_Historia_Clinica_Operatoria_Aprobar(
                        '$this->IdHistoriaClinicaOperatoria',
                        '$this->Aprobado'
					);";
