...
<head>
  <meta charset="utf-8">
  <title>Formato de Historia Clinica de Operatoria 2011-B</title>
  <style type="text/css">
    table th{
      text-align: center;
    }
...
<body>
  ...
  <div id="contenedor">
    <table id="cabecera">
      <tr>
        ...
        <th style="width:470px;">
          <h4>Formato de Historia Clinica de Operatoria 2011-B</h4>
   ...
   <?php 
    ...
    <tr>
       <td><strong> Dx y Tx Médico: </strong></td>
       <td><?php echo $Datos_Formato['Dx_Tx_Medico']; ?></td>
    </tr>
    <tr>
    ...
    <table class="tabla">
        ...
        <tr>		
		    ...
		    <td></td>
	         ...
	         <table>
	         <tr>
				   <td><strong>Estado Periodontal:</strong></td>
		    <td><?php echo $Datos_Formato['Estado_Periodontal']; ?></td>
	        </tr>
		<tr>
		...
		<h4>Cuadro de Avances</h4>
                ...
                <table class="tabla">
		  <tr>
                  <th>Retauración Tipo y Pieza</th>
                  <th>Recibo Número</th>
		  </tr>
		  <tr>
		...
		<table>
		    <tr>
		       <td><strong>Observaciones:</strong></td> 
                       <td><?php echo $Datos_Formato['Observaciones']; ?></td>
		    </tr> 
                </table>
