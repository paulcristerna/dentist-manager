...
<?php include("../core-saec/Administracion.php"); ?>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <div class="span9">
            <h2>Dinero Entregado a Departamentos</h2>
            
            <div id="campo-error"></div>
            
            <form method="get" action="reportes/dinero-entregado-departamentos-generar-pdf.php" target="_blank">
      ...
      <input type="hidden" id="ventana" value="dinero-entregado-departamentos">
