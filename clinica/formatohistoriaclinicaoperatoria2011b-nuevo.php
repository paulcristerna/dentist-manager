...
<script src="validacion_formatohistoriaclinicaoperatoria2011b.js"></script>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <form method="post" action="validacion_formatohistoriaclinicaoperatoria2011b.php" onsubmit="return validacion()">
            ...
            <div class="tab-pane active" id="tab1">
              ...
              <div class="row"> 
                <div class="span3">
                    ...
                    <select class="input-block-level2" id="sltpaciente-operatoria2011b" name="sltpaciente-operatoria2011b">
		...
		<div class="span1"> 
	            ...
	            <input type="text" style="width:100%;" name="edad" value="<?php echo (isset($Edad) ? $Edad:""); ?>">
                </div>
              </div>
              <br />
              <div class="row"> 
	            ...
	            <input type="text" style="width:100%;" name="ocupacion" value="<?php echo (isset($Datos_Paciente) ? $Datos_Paciente['Ocupacion']:""); ?>"> 
	        </div> 
                <div class="span2"> 
	            <label><strong>Teléfono: </strong></label>
	            <input type="text" style="width:100%;" name="telefono" value="<?php echo (isset($Datos_Paciente) ? $Datos_Paciente['Telefono']:"") ?>">
	        </div>
              </div>
              <br>
              <div class="row"> 
	           ...
	           <input type="text" style="width:100%;" name="calle" value="<?php echo (isset($Datos_Paciente) ? $Datos_Paciente['Calle']:""); ?>"> 
	        </div>
	        <div class="span1"> 
	           <label><strong> Número: </strong></label>
	           <input type="text" style="width:100%;" name="numero" value="<?php echo (isset($Datos_Paciente) ? $Datos_Paciente['Numero']:""); ?>"> 
	        </div>
              </div>
	      <br>
              <div class="row"> 
	           ...
	           <input type="text" style="width:100%;" name="colonia" value="<?php echo (isset($Datos_Paciente) ? $Datos_Paciente['Colonia']:""); ?>"> 
	        </div>
	        <div class="span2"> 
	           <label><strong> Población: </strong></label>
	           <input type="text" style="width:100%;" name="poblacion" value="<?php echo (isset($Datos_Paciente) ? $Datos_Paciente['Poblacion']:""); ?>"> 
	        </div>
              </div>
	      <br>
              <div class="row"> 
	           ...
	           <input type="text" style="width:100%;" name="email" value="<?php echo (isset($Datos_Paciente) ? $Datos_Paciente['Email']:""); ?>"> 
	        </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Dx y Tx Médico: </strong></label> </div>
                <div class="span3.5"> <input type="text" placeholder="Dx y Tx Médico" style="width:325%;" id="dx_tx_medico" name="dx_tx_medico"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2.5"> <label><strong> Observaciones Radiológicas </strong></label> </div>
                <div class="span5"> <textarea  rows="3" cols="10" style="width:105%;" placeholder="Observaciones Radiológicas" id="observaciones_radiologicas" name="observaciones_radiologicas"></textarea> </div>
              </div>
            </div><!-- fin tab1 -->
            <div class="tab-pane" id="tab2">
              ...
              <p>
                <a class="btn btn-institucional boton" id="diente-perdido">Diente Perdido (P)</a>
                <a class="btn btn-institucional boton" id="caries">Caries (C)</a>
                <a class="btn btn-institucional boton" id="dolor">Dolor (D)</a>
                <a class="btn btn-institucional boton" id="extraccion-indicada">Extracción Indicada (PI)</a>
                <a class="btn btn-institucional boton" id="protesis">Prótesis (PR)</a>
                <a class="btn btn-institucional boton" id="Obturacion">Obturación (O)</a>
                <a class="btn btn-institucional boton" id="traumatismo">Traumatismo (T)</a>
                <a class="btn btn-institucional boton" id="maloclusion">Maloclusiones (#)</a>
                <a class="btn btn-institucional boton" id="obturacion-defectuosa">Obturación Defectuosa (OD)</a>
                <a class="btn btn-institucional boton" id="endodoncia-indicada">Endodoncia o Indicada (E)</a>
              </p>
	      ...
	      <table class="table table-striped tabla-centrada">                
              ...
              <div class="row"> 
                ...
                <div class="span5"> <input type="text" placeholder="Estado Periodontal" style="width:100%;" id="estado_periodontal" name="estado_periodontal"> </div>
              </div>
              <br>
              <div class="row"> 
            ...
            <div class="row">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr> 
                    <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_1" name="restauracion_tipo_pieza_1"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_1" name="recibo_numero_1"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_2" name="restauracion_tipo_pieza_2"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_2" name="recibo_numero_2"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_3" name="restauracion_tipo_pieza_3"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_3" name="recibo_numero_3"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_4" name="restauracion_tipo_pieza_4"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_4" name="recibo_numero_4"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_5" name="restauracion_tipo_pieza_5"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_5" name="recibo_numero_5"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_6" name="restauracion_tipo_pieza_6"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_6" name="recibo_numero_6"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_7" name="restauracion_tipo_pieza_7"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_7" name="recibo_numero_7"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_8" name="restauracion_tipo_pieza_8"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_8" name="recibo_numero_8"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_9" name="restauracion_tipo_pieza_9"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_9" name="recibo_numero_9"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                  ...
                  <tr> 
                     <td><center><input type="text" style="width:75%;" id="restauracion_tipo_pieza_10" name="restauracion_tipo_pieza_10"></center></td>
                    <td><center><input type="text" style="width:75%;" id="recibo_numero_10" name="recibo_numero_10"></center></td>
                    <!--<td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
                    <td><center><input type="checkbox"></center></td>
              ...
              <div class="row"> 
                <div class="span8"> <textarea rows="3" cols="10" style="width:105%;" placeholder="Observaciones" id="observaciones" name="observaciones"></textarea> </div> 
              </div>
            </div><!-- fin tab3 -->
        </div><!-- fin tabcontent -->
