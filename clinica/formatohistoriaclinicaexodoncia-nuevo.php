...
<script src="validacion_formatohistoriaclinicaexodoncia.js"></script>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <form method="post" action="validacion_formatohistoriaclinicaexodoncia.php" onsubmit="return validacion()">
            ...
            <div class="tab-pane active" id="tab1">
              ...
              <div class="row"> 
                <div class="span3">
                    ...
                    <select class="input-block-level2" id="sltpaciente-exodoncia" name="sltpaciente-exodoncia">
              ...
              <div class="row"> 
	           ...
	           <input type="text" name="lugar-nacimiento" style="width:100%" placeholder="Lugar de Nacimiento" value="<?php echo (isset($_GET['paciente']) ? $Datos_Paciente['LugarNacimiento']:""); ?>">
                </div>
              </div>
              <br>
              <div class="row"> 
                ...
                <div class="span3.5"> <input type="text" placeholder="Diagnóstico" style="width:350px;" id="examen_buscal_diagnostico" name="examen_bucal_diagnostico"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1 offset1" style="padding-left:30px;"> <label><strong> Tratamiento: </strong></label> </div>
                <div class="span3.5"> <input type="text" placeholder="Tratamiento" style="width:350px;" id="examen_bucal_tratamiento" name="examen_bucal_tratamiento"> </div>
              </div>
            </div><!-- fin tab1 -->
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" placeholder="Cardiovascular" style="width:75%" id="aparatos_sistemas_cardiovascular" name="aparatos_sistemas_cardiovascular"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"><label><strong> Renal </strong></label></td>
                    <td><input type="text" placeholder="Renal" style="width:75%" id="aparatos_sistemas_renal" name="aparatos_sistemas_renal"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"><label><strong> Nervioso </strong></label></td>
                    <td><input type="text" placeholder="Nervioso" style="width:75%" id="aparatos_sistemas_nervioso" name="aparatos_sistemas_nervioso"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"><label><strong> Digestivo </strong></label></td>
                    <td><input type="text" placeholder="Digestivo" style="width:75%" id="aparatos_sistemas_digestivo" name="aparatos_sistemas_digestivo"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"><label><strong> Respiratorio </strong></label></td>
                    <td><input type="text" placeholder="Respiratorio" style="width:75%" id="aparatos_sistemas_respiratorio" name="aparatos_sistemas_respiratorio"></td>
                  </tr>
                </tbody>
              </table>
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="text" placeholder="Embarazo" style="width:75%" id="genitourinario_embarazo" name="genitourinario_embarazo"></td>
                  </tr>
                  <tr>
                    <td> <strong> Menopausia </strong> </td>
                    <td><input type="text" placeholder="Menopausia" style="width:75%" id="genitourinario_menopausia" name="genitourinario_menopausia"></td>
                  </tr>
                  <tr>
                    <td> <strong> Lactancia </strong> </td>
                    <td><input type="text" placeholder="Lactancia" style="width:75%" id="genitourinario_lactancia" name="genitourinario_lactancia"></td>
                  </tr>
                  <tr>
                    <td> <strong> Menstruación </strong> </td>
                    <td><input type="text" placeholder="Menstruación" style="width:75%" id="genitourinario_menstruacion" name="genitourinario_menstruacion"></td>
                  </tr>
                </tbody>
              </table>
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" placeholder="Propensión Hemorragíca" style="width:75%" id="propension_hemorragica" name="propension_hemorragica"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Pruebas de Laboratorio </strong> </td>
                    <td><input type="text" placeholder="Pruebas de Laboratorio" style="width:75%" id="pruebas_laboratorio" name="pruebas_laboratorio"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Estudio Radiológico </strong> </td>
                    <td><input type="text" placeholder="Estudio Radiológico" style="width:75%" id="estudio_radiologico" name="estudio_radiologico"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Estado General </strong> </td>
                    <td><input type="text" placeholder="Estado General" style="width:75%" id="estado_general" name="estado_general"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Indica la Extracción Dentaria </strong> </td>
                    <td><input type="text" placeholder="Indica la Extracción Dentaria" style="width:75%" id="extraccion_dentaria" name="extraccion_dentaria"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Analgesia Indicada </strong> </td>
                    <td><input type="text" placeholder="Analgesia Indicada" style="width:75%" id="analgesia_indicada" name="analgesia_indicada"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Prescripciones Operatorias </strong> </td>
                    <td><input type="text" placeholder="Prescripciones Operatorias" style="width:75%" id="prescripciones_operatorias" name="prescripciones_operatorias"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Complicaciones </strong> </td>
                    <td><input type="text" placeholder="Complicaciones" style="width:75%" id="complicaciones" name="complicaciones"></td>
                  </tr>
                  <tr>
                    <td style="width:250px"> <strong> Indicaciones al Paciente </strong> </td>
                    <td><input type="text" placeholder="Indicaciones al Paciente" style="width:75%" id="indicacion_paciente" name="indicacion_paciente"></td>
                  </tr>
                </tbody>
              </table>
            </div><!-- fin tab2 -->
