...
<script src="validacion_formatohistoriaclinicaprotesisparcialremovible.js"></script>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <form method="post" action="validacion_formatohistoriaclinicaprotesisparcialremovible.php" onsubmit="return validacion()">
            ...
            <div class="tab-pane active" id="tab1">
              ...
              <div class="row"> 
                <div class="span3">
                    ...
                    <select class="input-block-level2" id="sltpaciente-protesis-parcial-removible" name="sltpaciente-protesis-parcial-removible">
		...
		<div class="span2">
            ...
            <div class="tab-pane" id="tab2">
              ...
              <div class="row"> 
                ...
                <div class="span3.5"> <input type="text" placeholder="Estado de Salud General" style="width:450px;" id="estado_salud_general" name="estado_salud_general"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Problema Principal: </strong></label> </div>
                <div class="span3.5"> <input type="text" placeholder="Problema Principal" style="width:450px;" id="problema_principal_1" name="problema_principal_1"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Tratamiento: </strong></label> </div>
                <div class="span7"> <textarea rows="3" cols="10" style="width:100%;" placeholder="Tratamiento" id="tratamiento_1" name="tratamiento_1"></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Fecha de Última Visita al Médico: </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Fecha" class="span2 calendario" style="width:100px" id="ultima_visita_medico" name="ultima_visita_medico"> </div>
                <div class="span1"> <label><strong> Motivo: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:105%;" placeholder="Tratamiento" id="motivo_1" name="motivo_1"></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Estado de Salud Oral: </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Estado de Salud Oral" style="width:300%" id="estado_salud_oral" name="estado_salud_oral"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Problema Principal: </strong></label> </div>
                <div class="span2.5"> <input type="text" placeholder="Problema Principal" style="width:100%px" id="problema_principal_2" name="problema_principal_2"> </div>
                <div class="span1"> <label><strong> Tratamiento: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:100%;" placeholder="Tratamiento" id="tratamiento_2" name="tratamiento_2"></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Otros: </strong></label> </div>
                <div class="span3"> <input type="text" placeholder="Otros" style="width:110%" id="otros" name="otros"> </div>
                <div class="span1" style="padding-left:45px;"> <label><strong> Tratamiento: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:100%;" placeholder="Tratamiento" id="tratamiento_3" name="tratamiento_3"></textarea> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1.5"> <label><strong> Fecha de Última Visita al Dentista: </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Fecha" class="span2 calendario" style="width:100px" id="ultima_visita_dentista" name="ultima_visita_dentista"> </div>
                <div class="span1"> <label><strong> Motivo: </strong></label> </div>
                <div class="span3"> <textarea rows="3" cols="10" style="width:105%;" placeholder="Tratamiento" id="motivo_2" name="motivo_2"></textarea> </div>
              </div>
              <br>
              <div class="row"> 
              ...
              <div class="row"> 
                <div class="span1.5"> <input type="radio" id="motivo_perdida_piezas" name="motivo_perdida_piezas" value="1" checked> Caries </div>
                <div class="span2.5"> <input type="radio" id="motivo_perdida_piezas" name="motivo_perdida_piezas" value="2"> Enfermedad Periodontal </div>
                <div class="span1.5"> <input type="radio" id="motivo_perdida_piezas" name="motivo_perdida_piezas" value="3"> Trauma </div>
              </div>
              <br>
              <div class="row"> 
              ...
              <div class="row"> 
                <div class="span1.5"> <input type="radio" id="tiene_protesis" name="tiene_protesis" value="1" checked> Pobre </div>
                <div class="span1.5"> <input type="radio" id="tiene_protesis" name="tiene_protesis" value="2"> Regular </div>
                <div class="span1.5"> <input type="radio" id="tiene_protesis" name="tiene_protesis" value="3"> Buena </div>
              </div>
            </div><!-- fin tab2 -->
            ...
            <div class="tab-pane" id="tab3">
              ...
              <div class="row"> 
                ...
                <div class="span4"> <input type="text" placeholder="Forma" style="width:100%;" id="forma_1" name="forma_1"> </div>
                <div class="span1"> <label><strong> Color </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Color" style="width:100%" id="color_1" name="color_1"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Tamaño </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Tamaño" style="width:100%;" id="tamano_1" name="tamano_1"> </div>
                <div class="span1"> <label><strong> Posición </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Posición" style="width:100%" id="posicion" name="posicion"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span1"> <label><strong> Vitalidad Pulpar </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Vitalidad Pulpar" style="width:100%;" id="vitalidad_pulpar" name="vitalidad_pulpar"> </div>
              </div>
              <h3>Características de los Maxilares</h3>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Forma </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Forma" style="width:100%;" id="forma_2" name="forma_2"> </div>
                <div class="span1"> <label><strong> Tamaño </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Tamaño" style="width:100%" id="tamano_2" name="tamano_2"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2"> <label><strong> Relación Intermaxilar </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Relación Intermaxilar" style="width:100%;" id="relacion_intermaxilar" name="relacion_intermaxilar"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2"> <label><strong> Procesos Residuales </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Procesos Residuales" style="width:100%;" id="procesos_residuales" name="procesos_residuales"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Forma de Bóveda Palatina </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Forma de Bóveda Palatina" style="width:100%;" id="forma_boveda_palatina" name="forma_boveda_palatina"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Presencia de Torus </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Presencia de Torus" style="width:100%;" id="presencia_torus" name="presencia_torus"> </div>
              </div>
              <h3>Características de la Mucosa</h3>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Color </strong></label> </div>
                <div class="span4"> <input type="text" placeholder="Color" style="width:100%;" id="color_2" name="color_2"> </div>
                <div class="span1"> <label><strong> Consistencia </strong></label> </div>
                <div class="span1.5"> <input type="text" placeholder="Consistencia" style="width:100%" id="consistencia" name="consistencia"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span1"> <label><strong> Espesor </strong></label> </div>
                <div class="span2.5"> <input type="text" placeholder="Espesor" style="width:100%;" id="espesor" name="espesor"> </div>
                <div class="span2"> <label><strong> Altura a Nivel de Piezas </strong></label> </div>
                <div class="span3"> <input type="text" placeholder="Altura a Nivel de Piezas" style="width:100%;" id="altura_nivel_piezas" name="altura_nivel_piezas"> </div>
              </div>
              <br>
              <div class="row"> 
                <div class="span2"> <label><strong> Frenillos </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Frenillos" style="width:100%;" id="frenillos" name="frenillos"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Condiciones del Periodonto </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Condiciones del Periodonto" style="width:100%;" id="condiciones_periodonto" name="condiciones_periodonto"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Movilidad Dental </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Movilidad Dental" style="width:100%;" id="movilidad_dental" name="movilidad_dental"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> I.H.O.S. </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="I.H.O.S." style="width:100%;" id="ihos" name="ihos"> </div>
              </div>
               <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Clasificación de la Brecha </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Clasificación de la Brecha" style="width:100%;" id="clasificacion_brecha" name="clasificacion_brecha"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Hallazgos </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Hallazgos" style="width:100%;" id="hallazgos" name="hallazgos"> </div>
              </div>
              <br> 
              <div class="row"> 
                <div class="span2"> <label><strong> Estudio Radiográfico </strong></label> </div>
                <div class="span5"> <input type="text" placeholder="Estudio Radiográfico" style="width:100%;" id="estudio_radiografico" name="estudio_radiografico"> </div>
              </div>
            </div><!-- fin tab4 -->
