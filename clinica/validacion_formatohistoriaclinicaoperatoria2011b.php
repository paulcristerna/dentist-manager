...
include("../core-saec/Formato_Historia_Clinica_Operatoria_2011B.php");
...
if(isset($_REQUEST['guardar']))
{
    ...
    $Paciente = $_POST["sltpaciente-operatoria2011b"];
    ...
    $Dx_Tx_Medico = $_POST["dx_tx_medico"];
    $Observaciones_Radiologicas = $_POST["observaciones_radiologicas"];
    ...
    $Estado_Periodontal = $_POST["estado_periodontal"];
    $Plan_Tratamiento = $_POST["plan_tratamiento"];
    $Restauracion_Tipo_Pieza_1 = $_POST["restauracion_tipo_pieza_1"];
    $Restauracion_Tipo_Pieza_2 = $_POST["restauracion_tipo_pieza_2"];
    $Restauracion_Tipo_Pieza_3 = $_POST["restauracion_tipo_pieza_3"];
    $Restauracion_Tipo_Pieza_4 = $_POST["restauracion_tipo_pieza_4"];
    $Restauracion_Tipo_Pieza_5 = $_POST["restauracion_tipo_pieza_5"];
    $Restauracion_Tipo_Pieza_6 = $_POST["restauracion_tipo_pieza_6"];
    $Restauracion_Tipo_Pieza_7 = $_POST["restauracion_tipo_pieza_7"];
    $Restauracion_Tipo_Pieza_8 = $_POST["restauracion_tipo_pieza_8"];
    $Restauracion_Tipo_Pieza_9 = $_POST["restauracion_tipo_pieza_9"];
    $Restauracion_Tipo_Pieza_10 = $_POST["restauracion_tipo_pieza_10"];
    
    $Recibo_Numero_1 = $_POST["recibo_numero_1"];
    $Recibo_Numero_2 = $_POST["recibo_numero_2"];
    $Recibo_Numero_3 = $_POST["recibo_numero_3"];
    $Recibo_Numero_4 = $_POST["recibo_numero_4"];
    $Recibo_Numero_5 = $_POST["recibo_numero_5"];
    $Recibo_Numero_6 = $_POST["recibo_numero_6"];
    $Recibo_Numero_7 = $_POST["recibo_numero_7"];
    $Recibo_Numero_8 = $_POST["recibo_numero_8"];
    $Recibo_Numero_9 = $_POST["recibo_numero_9"];
    $Recibo_Numero_10 = $_POST["recibo_numero_10"];
    ...
    $Formato_Historia_Clinica_Operatoria_2011B = new Formato_Historia_Clinica_Operatoria_2011B (
        ...
        $Estado_Periodontal,
        $Plan_Tratamiento,
        $Restauracion_Tipo_Pieza_1,
        $Restauracion_Tipo_Pieza_2,
        $Restauracion_Tipo_Pieza_3,
        $Restauracion_Tipo_Pieza_4,
        $Restauracion_Tipo_Pieza_5,
        $Restauracion_Tipo_Pieza_6,
        $Restauracion_Tipo_Pieza_7,
        $Restauracion_Tipo_Pieza_8,
        $Restauracion_Tipo_Pieza_9,
        $Restauracion_Tipo_Pieza_10,    
        $Recibo_Numero_1,
        $Recibo_Numero_2,
        $Recibo_Numero_3,
        $Recibo_Numero_4,
    ...
    $Formato_Historia_Clinica_Operatoria_2011B->Alta();
} 
...
if(isset($_REQUEST['aprobar']))
{
    ...
    $Formato_Historia_Clinica_Operatoria_2011B->IdHistoriaClinicaOperatoria2011B = $Historia_Clinica;
    $Formato_Historia_Clinica_Operatoria_2011B->Aprobado = $Aprobado;
    
    $Formato_Historia_Clinica_Operatoria_2011B->Aprobar();
}
?>