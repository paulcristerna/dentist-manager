...
<script src="validacion_total-egresos.js"></script>
    ...
    <div class="container">
      ...
      <div class="row" id="contenido-sistema">
        ...
        <div class="span9">
            ...
            <form method="get" onsubmit="return validacion_total_egresos()" action="reportes/total-egresos-generar-pdf.php" target="_blank">
      ...
      <input type="hidden" id="ventana" value="total-egresos">
